    ...
    describe "#store_upload" do
      it "returns the correct url for default multisite db" do
        expect(store.store_upload(uploaded_file, upload)).to eq(
          "//#{SiteSetting.s3_upload_bucket}.s3.dualstack.us-east-1.amazonaws.com/original/2X/c/c530c06cf89c410c0355d7852644a73fc3ec8c04.png"
        )

        conn.with_connection('second') do
          expect(store.store_upload(uploaded_file, upload)).to eq(
            "//#{SiteSetting.s3_upload_bucket}.s3.dualstack.us-east-1.amazonaws.com/uploads/second/original/2X/c/c530c06cf89c410c0355d7852644a73fc3ec8c04.png"
          )
        end
      end
    end
